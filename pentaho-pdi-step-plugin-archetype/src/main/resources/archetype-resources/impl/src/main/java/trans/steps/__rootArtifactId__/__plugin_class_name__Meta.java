 ...
 * under the License.
 */
package ${package}.trans.steps.${rootArtifactId};
 ...
 */
@Step( id = "${plugin_class_name}", image = "${rootArtifactId}/ui/images/${plugin_class_name}.svg", i18nPackageName ="${package}.trans.steps.${rootArtifactId}",
  name = "${plugin_class_name}.Name", description = "${plugin_class_name}.Description",
  categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.${plugin_category}" )
public class ${plugin_class_name}Meta extends BaseStepMeta implements StepMetaInterface {
  
  private static Class<?> PKG = ${plugin_class_name}.class; // for i18n purposes, needed by Translator2!!
  ...
  public String getDialogClassName() {
    return "${package}.ui.trans.steps.${rootArtifactId}.${plugin_class_name}Dialog";
  }
}
